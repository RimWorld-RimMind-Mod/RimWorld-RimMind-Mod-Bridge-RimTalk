...
**Q: 设置变更后需要重启吗？**
A: 上下文推送和拉取的变更需要重启游戏才能生效（设置界面有提示）。对话门控的变更即时生效。
...
A: Context push and pull changes require a game restart (indicated in the settings UI). Dialogue gate changes take effect immediately.
